...
const I18N = {
  ...
  strings: {
    en: {
      ...
      githubGistInDevelopment: 'GitHub Gist Sync is under development and not available yet',
      ...
      webdavMissingConfig: 'Please complete WebDAV URL, username, and application password',
      webdavTesting: 'Testing WebDAV connection...',
      webdavUploading: 'Uploading to WebDAV...',
      webdavDownloading: 'Downloading from WebDAV...',
      webdavConnectionSuccess: 'WebDAV connection successful!',
      webdavServiceOffline: 'WebDAV service is unavailable',
      webdavAuthFailed: 'WebDAV authentication failed',
      webdavDirectoryCreated: 'WebDAV directory created successfully',
    ...
    zh: {
      ...
      githubGistInDevelopment: 'GitHub Gist 同步功能正在开发中，暂未提供',
      ...
      webdavMissingConfig: '请填写完整的 WebDAV URL、用户名和应用密码',
      webdavTesting: '正在测试 WebDAV 连接...',
      webdavUploading: '正在上传到 WebDAV...',
      webdavDownloading: '正在从 WebDAV 下载...',
      webdavConnectionSuccess: 'WebDAV 连接成功！',
      webdavServiceOffline: 'WebDAV 服务不可用',
      webdavAuthFailed: 'WebDAV 认证失败',
      webdavDirectoryCreated: 'WebDAV 目录创建成功',
